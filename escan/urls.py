...
urlpatterns = [
    ...
    path('admin-revenue/', views.admin_monthly_revenue_api, name='admin_revenue_api'),
    ...
    path('revenue-logs/', views.admin_revenue_logs, name='admin_revenue_logs'),
    path('revenue-logs/export/', views.export_admin_revenue_csv, name='export_admin_revenue_csv'),
